...
class HomeViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIScrollViewDelegate {
    ...
    func SetUpObject() {
        currentLan = TPreferences.readString(LANGUAGE) ?? ""
    ...
    func Arabic() {
        ...
        cvNewestProduct.scrollToItem(at: indexPath, at: .left, animated: false)
        cvRecentSearch.scrollToItem(at: indexPath, at: .left, animated: false)
        cvFeaturedProduct.scrollToItem(at: indexPath, at: .left, animated: false)
//        cvCategory.scrollToItem(at: indexPath, at: .left, animated: false)
        cvDealProducts.scrollToItem(at: indexPath, at: .left, animated: false)
        cvSuggestedProducts.scrollToItem(at: indexPath, at: .left, animated: false)
        cvOffers.scrollToItem(at: indexPath, at: .left, animated: false)
        cvYouMayLike.scrollToItem(at: indexPath, at: .left, animated: false)
    }
        ...
        if collectionView == cvTestimonials {
            ...
            if arrCategory.count == 0 {
                ...
                if IPAD {
                    ...
                    self.ConstraintHeightCvCategory.constant = 90
                }
            }
            ...
            if arrRecentSearch.count == 0 {
                ...
                if IPAD {
                    ...
                    self.ConstraintHeightCvRecentSearchHeader.constant = 70
                }else {
                    self.ConstraintHeightCvRecentSerach.constant = 260
                    self.ConstraintHeightCvRecentSearchHeader.constant = 50
                }
            }
            
            if arrRecentSearch.count > 5 {
                return 5
            }
            else {
            ...
            if arrFeaturedProduct.count == 0 {
                ...
                if IPAD {
                    ...
                    self.ConstraintHeightCvFeturedHeader.constant = 70
                }else {
                    self.ConstraintHeightcvFeaturedProduct.constant = 260
                    self.ConstraintHeightCvFeturedHeader.constant = 50
                }
            }
            ...
            if arrProducts.count == 0 {
                ...
                if IPAD {
                    ...
                    self.ConstraintHeightCvNewestHeader.constant = 70
                }else {
                    self.ConstraintHeightCvNewProduct.constant = 260
                    self.ConstraintHeightCvNewestHeader.constant = 50
                }
            }
            ...
            if arrDealProducts.count == 0 {
                ...
                if IPAD {
                    ...
                    self.constraintDealProductsHeaderHeight.constant = 70
                }else {
                    self.constraintCvDealProductsHeight.constant = 260
                    self.constraintDealProductsHeaderHeight.constant = 50
                }
            }
            
            if arrDealProducts.count > 5 {
                return 5
            }
            else {
            ...
            if arrSuggestedProducts.count == 0 {
                ...
                if IPAD {
                    ...
                    self.constraintSuggestedProductsHeaderHeight.constant = 70
                }else {
                    self.constraintCvSuggestedProductsHeight.constant = 260
                    self.constraintSuggestedProductsHeaderHeight.constant = 50
                }
            }
            
            if arrSuggestedProducts.count > 5 {
                return 5
            }
            else {
            ...
            if arrOffers.count == 0 {
                ...
                if IPAD {
                    ...
                    self.constraintOffersHeaderHeight.constant = 70
                }else {
                    self.constraintCvOffersHeight.constant = 260
                    self.constraintOffersHeaderHeight.constant = 50
                }
            }
            
            if arrOffers.count > 5 {
                return 5
            }
            else {
            ...
            if arrYouMayLike.count == 0 {
                ...
                if IPAD {
                    ...
                    self.constraintYouMayLikeHeaderHeight.constant = 70
                }else {
                    self.constraintCvYouMayLikeHeight.constant = 260
                    self.constraintYouMayLikeHeaderHeight.constant = 50
                }
            }
            
            if arrYouMayLike.count > 5 {
                return 5
            }
            else {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if IPAD {
            if collectionView == cvTestimonials {
                ...
                return CGSize(width:(self.cvRecentSearch.frame.width / 3) - 8 , height: 350)
            }
            else if collectionView == cvNewestProduct {
                return CGSize(width:(self.cvNewestProduct.frame.width / 3) - 8 , height: 350)
            }
            else if collectionView == cvFeaturedProduct {
                return CGSize(width:(self.cvFeaturedProduct.frame.width / 3) - 8 , height: 350)
            }
            else if collectionView == cvDealProducts {
                return CGSize(width:(self.cvDealProducts.frame.width / 3) - 8 , height: 350)
            }
            else if collectionView == cvSuggestedProducts {
                return CGSize(width:(self.cvSuggestedProducts.frame.width / 3) - 8 , height: 350)
            }
            else if collectionView == cvOffers {
                return CGSize(width:(self.cvOffers.frame.width / 3) - 8 , height: 350)
            }
            else if collectionView == cvYouMayLike {
                return CGSize(width:(self.cvYouMayLike.frame.width / 3) - 8 , height: 350)
            }
            else {
            ...
            if collectionView == cvTestimonials {
                ...
                return CGSize(width:(self.cvRecentSearch.frame.width / 2) , height: 250)
            }
            else if collectionView == cvNewestProduct {
                return CGSize(width:(self.cvNewestProduct.frame.width / 2) , height: 250)
            }
            else if collectionView == self.cvFeaturedProduct {
                return CGSize(width:(self.cvFeaturedProduct.frame.width / 2) , height: 250)
            }
            else if collectionView == cvDealProducts {
                return CGSize(width:(self.cvDealProducts.frame.width / 2) , height: 250)
            }
            else if collectionView == cvSuggestedProducts {
                return CGSize(width:(self.cvSuggestedProducts.frame.width / 2) , height: 250)
            }
            else if collectionView == cvOffers {
                return CGSize(width:(self.cvOffers.frame.width / 2) , height: 250)
            }
            else if collectionView == cvYouMayLike {
                return CGSize(width:(self.cvYouMayLike.frame.width / 2) , height: 250)
            }
            else {
                return CGSize(width:0 , height: 0)
            }
                ...
                if let data = response.result.value{
                    if response.response?.statusCode == 200 {
                        ...
                        if dicDashboard.value(forKey: "theme_color") != nil {
                            ...
                            if strColor == ""{
                                dicPlist.setValue("fc4253", forKey: "Primary_Default_Color")
                                dicPlist.setValue("fc4253", forKey: "header_color")
                                
                                dicDefaultNight.setValue("fc4253", forKey: "Primary_Default_Color")
                                dicDefaultNight.setValue("fc4253", forKey: "header_color")
                                TPreferences.writeString("fc4253", value: strColor)
                            } else {
